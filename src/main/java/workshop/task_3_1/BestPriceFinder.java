...
public class BestPriceFinder {
    ...
    private static final Function<ProductPrice, ProductPrice> FINAL_PRICER = price -> {
    ...
    public static List<ProductPrice> findPricesSequential(List<Shop> shops, String product) {
        ...
        return shops.stream()
                .map(shopPricer.andThen(FINAL_PRICER::apply))
        ...
        List<CompletableFuture<ProductPrice>> priceFutures =
                shops.stream()
                        .map(shop -> CompletableFuture
                                ...
                                .thenApplyAsync(FINAL_PRICER::apply, executorFinalPrice))
                        .collect(Collectors.toList());
